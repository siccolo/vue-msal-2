...
var msalPlugin = /** @class */ (function () {
    function msalPlugin(options, Vue) {
        ...
        var exposed = {
            ...
            authenticatePopup: function () { msal.authenticatePopup(); },
            authenticatePopupAsync: function () {
                return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, msal.authenticatePopupAsync()];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
            ...
            logoutPopup: function () {
                return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, msal.logoutPopup()];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
